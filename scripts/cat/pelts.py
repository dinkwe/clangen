...
class Pelt:
    ...
    eye_colours = [
        ...
        #STARCATCHER EYES
        'TORBIN', 'DARKLEAP', 'PASTEL BLUES', 'YELLOW SHEEN', 'PUMPKIN ORANGE', 'PASTEL YELLOW', 'ALGAE2', 'ANGELIC YELLOW',
    ...
    yellow_eyes = [
        ...
        'YELLOW SHEEN', 'PASTEL YELLOW', 'ANGELIC YELLOW', 'SUNSHINE', 'LIGHT MELON', 'HEADLIGHTS', 'GRASS',
