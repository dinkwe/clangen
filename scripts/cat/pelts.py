...
class Pelt:
    ...
    blue_eyes = [
        ...
        'UTRICULARIA', 'UMBELLA', 'PROTEA', 'CONIFERA', 'HYDROPHYLLA', 'OROBANCHA'
    ]
    ...
    orange_eyes = [
        ...
        'TEREBINTHA', 'TIMBER', 'VITA', 'WORMY', 'CEDAR', 'DUSKY', 'DAWN SKIES'
    ]
    ...
    black_eyes = [
        ...
        'MIDNIGHT', 'PHANTOM', 'STEEL', 'STORMY', 'NYMPHEA', 'BERBERIDA', 'GOODENIA', 'MAGNOLIA', 'PAPAVERA',
        'RANUNCULA', 'VIOLA', 'CURSE', 'COMBRETA'
    ]
