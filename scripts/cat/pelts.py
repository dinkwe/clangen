...
class Pelt:
    ...
    eye_colours = [
        ...
        'HYDRANGEA','TURQUOISE2','PALE PRIMARY','SAFARI','SOMETHING WICKED','SHINY BROWN','RED GRAY','PRINCESS','PALE INDIGO','ICERBERG','CROCODILE','STARLESS NIGHT',
        ...
        'GATORADE','WASP','GLARE','PASTEL SUMMER','DARKNESS','LASER BEAM','BRIGHT CYAN','INK JET','LAST SUNSET','GREEN-8','MYSTERY','HADES',
        ...
        'LIGHT GRAY','SEASIDE','CAIN','ORANGE-15','KELPIE','CELESTITE','PALE ROSE','INDIGO-4','SOFT TRANS','ZABA'
        ...
        'SETTING SUN','PURPLE SKY','FADED PINK','SPARKLING SODA','BRIGHT OLIVE','YEW','MINT LIME','BLUE FLAX','INDIGO-6','BEACHBALL','RED-ORANGE','HOLLY',
        ...
        'FAUX GRASS','IDIA','SILVER CYAN','DIAMOND','RUBY SAPPHIRE','VIOLET-10','PINK-SILVER','SHINY VELVET','SYNTHWAVE','CUCUMBER'
    ...
    cyan_eyes = ['ANGELIC ALGAE', 'AQUA', 'AQUAMARINE', 'MERCY',
                 ...
                 'BUBBLES', 'MIKU', 'TEAL2', 'BATESIA', 'ICY CYAN', 'RUSTED BLUE', 'ICERBERG', 'STRANGE CYAN', 'JADE']
    ...
    def init_eyes(self, parents):
        ...
        if not parents:
            ...
            colour_wheel = [Pelt.yellow_eyes, Pelt.darkblue_eyes, Pelt.lightblue_eyes, Pelt.green_eyes, Pelt.red_eyes, Pelt.violet_eyes, Pelt.chartreuse_eyes, Pelt.indigo_eyes, Pelt.orange_eyes, Pelt.black_eyes,
                            Pelt.neos_eyes, Pelt.flutter_eyes, Pelt.lamp_eyes, Pelt.angel_eyes, Pelt.snail_eyes, Pelt.aquatic_eyes, Pelt.demon_eyes, Pelt.primal_eyes,
                            Pelt.aerial_eyes, Pelt.floral_eyes, Pelt.silver_eyes, Pelt.gray_eyes, Pelt.white_eyes, Pelt.pink_eyes, Pelt.brown_eyes]
            similar_colors = []
            for i in parents:
