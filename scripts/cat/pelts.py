...
class Pelt:
    ...
    yellow_eyes = [
        ...
        'PASTEL BEACH', 'LIGHT MELON2', 'PASTEL HEADLIGHTS', 'FOIL GOLD', 'BRIGHT LIGHT FR', 'BASIC LIGHT FR',
        'UNUSUAL LIGHT FR', 'GOLD SCARAB', 'SUNNY', 'FOOLS GOLD', 'LIGHT GOLD', 
    ]
    ...
    blue_eyes = [
        ...
        'COTTON CANDY2', 'SEASHELL2', 'OCEANIC SEASHELL', 'LOL BLUE', 'BRIGHT WATER FR', 'BRIGHT ICE FR',
        'BASIC WATER FR', 'BASIC LIGHTNING FR', 'BASIC ICE FR', 'FADED WATER FR', 'FADED LIGHTNING FR',
        'PASTEL WATER', 'PASTEL LIGHTNING FR', 'UNUSUAL WATER FR', 'UNUSUAL LIGHTNING FR', 'UNUSUAL ICE FR',
        'BLUE ALBINO', 'LIGHT BLUE ALBINO', 'CYAN ALBINO', 'SEAFOAM SPLASH', 'TSUNAMI', 'BLUE MOON',
        'SUBMERGED', 'BLUEBERRY', 
    ]
    ...
    green_eyes = [
        ...
        'BRIGHT WIND FR', 'BRIGHT LIGHTNING FR', 'BRIGHT NATURE FR', 'BASIC WIND FR', 'BASIC NATURE',
        'FADED WIND FR', 'FADED NATURE FR', 'PASTEL WIND FR', 'PASTEL NATURE FR', 'UNUSUAL WIND FR', 'UNUSUAL NATURE FR',
        'GLORY', 'SWAMP GOLD', 'LIME', 'DAMP MOSS', 
    ]
    ...
    red_eyes = [
        ...
        'RED GREY2', 'DARK PINK VELVET', 'BRIGHT PLAGUE FR', 'BASIC PLAGUE FR', 'FADED PLAGUE FR', 'PASTEL PLAGUE FR',
        'UNUSUAL PLAGUE FR', 'RED ALBINO', 'PINK ALBINO', 'CLAY', 'PEACEBRINGER', 'PERIL', 'ROSEGOLD FLUTTER',
        'VELVET', 'MERRY CHRISTMAS', 'SPINEL', 
    ]
    ...
    orange_eyes = [
        ...
        'WOWIE MELON', 'BURNET AMBER', 'CARAMEL APPLE', 'NYMPHEA', 'BRIGHT EARTH FR', 'BRIGHT FIRE FR',
        'BASIC EARTH FR', 'BASIC FIRE FR', 'PASTEL FIRE FR', 'UNUSUAL EARTH FR', 'UNUSUAL FIRE FR', 'ORANGENEW',
        'COOKIE', 'TRICK OR TREAT', 'NEW DAWN'
    ]
    ...
    purple_eyes = [
        ...
        'CAPPARIDA', 'FUMARIA', 'THYMELA', 'URTICA', 'STARFLIGHT', 
        ...
        'PASTY PURPLE', 'PASTEL LILAC', 'GRAPE SEEDS', 'BRIGHT PUMPKIN', 'PURPLE SUNSET', 'BRIGHT SHADOW FR',
        'BRIGHT ARCANE FR', 'BASIC SHADOW FR', 'BASIC ARCANE FR', 'PAPAVERA', 'FADED SHADOW FR', 'FADED ARCANE FR',
        'PASTEL SHADOW FR', 'PASTEL ARCANE FR', 'UNUSUAL SHADOW FR', 'UNUSUAL ARCANE FR', 'GRAPE', 
    ]
    
    black_eyes = [
        'BLACK', 'BULLET', 'CISTA', 'GREY SILVER', 'POLYGALA', 'RESEDA', 'SAXIFRAGA', 'SILVER', 'CLOUDY', 'GREY',
        'MIDNIGHT', 'PHANTOM', 'STEEL', 'STORMY', 'NYMPHEA', 'BERBERIDA', 'GOODENIA', 'MAGNOLIA',
        ...
        'LILAC COFFEE', 'STARDUST', 'FADED EARTH FR', 'FADED ICE FR', 'FADED LIGHT FR', 'FADED FIRE FR', 'PASTEL EARTH FR',
        'PASTEL ICE FR', 'PASTEL LIGHT FR', 'DARKSTALKER', 'COLD MONOCHROME', 'MOON', 'WARM MONOCHROME',
        'PURPLE MYSTERY', 
    ]
