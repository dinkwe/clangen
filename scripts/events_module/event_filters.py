...
def _get_cats_with_trait(cat_list: list, traits: tuple) -> list:
    ...
    return [kitty for kitty in cat_list if (kitty.personality.trait in traits or kitty.personality.trait2 in traits)]
...
def _get_cats_without_trait(cat_list: list, traits: tuple) -> list:
    ...
    return [kitty for kitty in cat_list if (kitty.personality.trait not in traits and kitty.personality.trait2 not in traits)]
