...
class CustomizeCatScreen(Screens):
    def __init__(self, name=None):
        ...
        self.pelt_colours = copy(Pelt.single_colours)
        ...
        self.accessories += Pelt.colorsplash_accessories
    ...
    def setup_dropdowns(self):
        ...
        if self.sparkle_cats:
            self.eye_colours = [colour.capitalize() for colour in copy(Pelt.eye_colours)]
            self.eye_colours.sort()
            temp = [colour.capitalize() for colour in copy(Pelt.flutter_eyes)]
            temp += [colour.capitalize() for colour in copy(Pelt.lamp_eyes)]
            temp += [colour.capitalize() for colour in copy(Pelt.neos_eyes)]
            temp += [colour.capitalize() for colour in copy(Pelt.angel_eyes)]
            temp += [colour.capitalize() for colour in copy(Pelt.snail_eyes)]
            temp.sort()
            self.eye_colours += temp
        else:
            self.eye_colours = [colour.capitalize() for colour in copy(Pelt.eye_colours)]
            self.eye_colours.sort()
