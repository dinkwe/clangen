        ...
        if related and other_cat and not mates:
            ...
            if cat.is_uncle_aunt(other_cat):
                if other_cat.genderalign in ("female", "trans female"):
                    ...
                    parents = [other_cat.fetch_cat(i) for i in parents if other_cat.fetch_cat(i)]
                    for par in parents:
                        if par.is_sibling(cat) or cat.is_sibling(par):
                ...
                if other_cat.genderalign in ("female", "trans female"):
                    ...
                    parents = [cat.fetch_cat(i) for i in parents if cat.fetch_cat(i)]
                    for par in parents:
                        if par.is_sibling(other_cat) or other_cat.is_sibling(par):
                            if par.genderalign in ["female", "trans female"]:
